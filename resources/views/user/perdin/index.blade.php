            ...
            <div class="col-xxl-8 mb-6 order-0">
                <div class="card">
                    <div class="d-flex align-items-start row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary mb-3">Selamat Datang  {{ $name }}🎉</h5>
                                <p class="mb-6">
                                    Anda memiliki 3 perjalanan yang menunggu persetujuan.<br />Perjalanan ke Jakarta dimulai besok.
                                </p>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-6">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <p class="mb-1">Total Perjalan</p>
                                <h4 class="card-title mb-3">{{ $jumlah }}</h4>
